...
def get_simulation_test_data() -> dict:
    ...
    return {
        ...
        # Reynolds Model Variables for dimensional model creation
        "REYNOLDS_MODEL_VARIABLES": {
            "\\rho": {
                "_idx": 0,
                "_sym": "\\rho",
                "_alias": "rho",
                ...
                "_units": "kg/m^3",
                "name": "Density",
                "description": "Fluid density for Reynolds number calculation",
                "relevant": True,
                "_min": 1.0,
                "_max": 1000.0,
                "_mean": 500.0,
                ...
                "_step": 10.0,
                "_dist_type": "uniform",
                "_dist_params": {"low": 100.0, "high": 1000.0},
                "_depends": []
            },
            "v": {
                "_idx": 1,
                ...
                "_units": "m/s",
                "name": "Velocity",
                "description": "Fluid velocity for Reynolds number calculation",
                "relevant": True,
                "_min": 0.1,
                "_max": 10.0,
                "_mean": 5.0,
                ...
                "_step": 0.1,
                "_dist_type": "uniform",
                "_dist_params": {"low": 1.0, "high": 10.0},
                "_depends": []
            },
            "L": {
                "_idx": 2,
                ...
                "description": "Characteristic length (output for Reynolds analysis)",
                "relevant": True,
                "_min": 0.01,
                "_max": 1.0,
                "_mean": 0.5,
            ...
            "\\mu": {
                ...
                "_units": "Pa*s",
                "name": "Dynamic Viscosity",
                "description": "Dynamic viscosity for Reynolds number calculation",
                "relevant": True,
                "_min": 0.001,
                "_max": 0.1,
                "_mean": 0.01,
                ...
                "_step": 0.001,
                "_dist_type": "uniform",
                "_dist_params": {"low": 0.001, "high": 0.1},
                "_depends": []
            },
        },
        ...
        "REYNOLDS_EXPR": "\\frac{\\rho \\cdot v \\cdot L}{\\mu}",
        ...
        # Fundamental Dimensional Units for CUSTOM framework
        "FDU_LIST": [
            {
                "_idx": 0,
                "_sym": "M",
        ...
        # Channel Flow Variables for dimensional model
