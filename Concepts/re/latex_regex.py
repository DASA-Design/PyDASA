...
# LATEX_REGEX = r"^(\\[a-zA-Z]+(_\{[a-zA-Z0-9]+\})?(\^\{[a-zA-Z0-9]+\})?(\*[a-zA-Z0-9]*)?(\{[a-zA-Z0-9*+\-/]+\})?(\{[a-zA-Z0-9*+\-/]+\})?|[a-zA-Z]+)$"

# LATEX_REGEX = r"^(\\[a-zA-Z]+(_\{[a-zA-Z0-9]+\})?(\^\{[a-zA-Z0-9]+\})?(\*[a-zA-Z0-9]*)?(\{[a-zA-Z0-9*+\-/]+\})?(\{[a-zA-Z0-9*+\-/]+\})?|[a-zA-Z]+(\*[a-zA-Z0-9]+)?)$"

# LATEX_REGEX = r"^(\\[a-zA-Z]+(_\{[a-zA-Z0-9]+\})?(\^\{[a-zA-Z0-9.+\-*/]+\})?(\*[a-zA-Z0-9]*)?(\{[a-zA-Z0-9*+\-/]+\})?(\{[a-zA-Z0-9*+\-/]+\})?|[a-zA-Z0-9]+(\([a-zA-Z0-9*+\-/]+\))?(\*[a-zA-Z0-9]+)?(/[a-zA-Z0-9*+\-/()]+)?)$"
