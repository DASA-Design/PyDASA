...
class SensitivityAnalysis(Generic[T]):
    ...
    _cat: str = "SYM"
    """
    Category of the *SensitivityAnalysis*. It can be one of the following: `SYM`, `NUM` or `CUSTOM` and decides which method to use for the analysis. By default, it is set to `SYM`.
    """
    ...
    def cat(self, val: str) -> None:
        """*cat* Sets the category of the *SensitivityAnalysis*. It can be one of the following: `SYM`, `NUM` or `CUSTOM`.
