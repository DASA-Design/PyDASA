...
class TestVariable(unittest.TestCase):
    ...
    def test_inheritance_from_validation(self) -> None:
        """Test that Variable inherits from Validation hierarchy."""
        from pydasa.core.basic import Validation, IdxValidation, SymValidation

        var = Variable()

        assert isinstance(var, Variable)
        assert isinstance(var, Validation)
        assert isinstance(var, IdxValidation)
        assert isinstance(var, SymValidation)
