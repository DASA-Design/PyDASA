...
class DimensionalModel(Generic[T]):
    ...
    def _validate_param_lt(self, param_lt: List[Parameter]) -> bool:
        ...
        # check if the number of outputs is valid, ONLY ONE OUT!
...
class DimensionalAnalyzer(DimensionalModel[T]):
    ...
    _n_out: int = 0
    """
    Number of OUT parameters. Max Number must be 1. Conforms the output vector of the main Dimensional Matrix.
    """

    # :attr: _n_ctrl
    _n_ctrl: int = 0
    """
    Number of CTRL parameters. It is the number of relevant parameters minus the number of input and output parameters. Conforms the residual Dimensional Matrix and can be as many as necessary
    """
    ...
    """
    Output parameter of the analysis. It must be a single *Parameter* object with the 'cat' and 'relevance' attributes set to `OUT` and `True`, respectively. It is used to define the output vector of the dimensional matrix.
    """
